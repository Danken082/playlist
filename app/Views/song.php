...
<body>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
     ...
     <a href="#" data-bs-toggle ="modal" data-bs-target ="#myModal">View List</a>
  ...
  <form action="/search" method="get">
    ...
    <button type="submit" class="btn btn-primary">Search</button>
        ...
        <h1>Music Player</h1>
        <button type="button" class= "btn btn-primary" data-bs-toggle = "modal" data-bs-target="#dan">Insert Music</button>
...
<?php if ($music): ?>
        <?php foreach ($music as $msc): ?>
            <li data-src="<?= base_url(); ?>/song/<?= $msc['file'];?>.mp3"><?= $msc['file']; ?>
              <a href="<?= $msc['id']?>" data-bs-toggle ="modal" data-bs-target ="#addPlaylist">
